...
<aside class="main-sidebar">
    ...
    <!-- search form (Optional) -->
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview {{ Request::is('capacitaciones') ? 'active' : '' }}">
                <a href="#">
                    <i class='fa fa-link'></i>
                ...
                <ul class="treeview-menu">
                    <li class="{{ Request::is('capacitaciones') ? 'active' : '' }}">
                        <a href="/capacitaciones">Ver todas</a>
                    </li>
                    <li>
                        <a href="#">{{ trans('adminlte_lang::message.linklevel2') }}</a>
                    </li>
                </ul>
            </li>
        </ul><!-- /.sidebar-menu -->
